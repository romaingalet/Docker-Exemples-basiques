# Quelques exemples de génération d'images Docker
  ...
  - [ ] projet 7 : Exécution d'un container basé sur ign/geopython lançant un programme Python simple (affichage d'un hello). Image récupérer par un pull sur un docker registry.
